...
# In case multivariate dataset: Take each variate as univariate dataset and compute their DTWs. Sum DTWs on variates.
dataset_dir = './datasets/univariate'
output_dir = './tmp'

def argsparser():
    parser = argparse.ArgumentParser("SiGNN dtw creator")
    parser.add_argument('--dataset', help='Dataset name', default='ECG5000')
